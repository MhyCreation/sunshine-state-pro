...
const nav = [
  ...
  { href: "/games/plinko", icon: Diamond, label: "Plinko" },
  { href: "/games/dice", icon: Spade, label: "Dice" },
  { href: "/games/wheel", icon: Club, label: "Wheel" },
  { href: "/games/hilo", icon: Heart, label: "Hi-Lo" },
  { href: "/games/dragon-tiger", icon: Diamond, label: "Dragon Tiger" },
  { href: "/games/limbo", icon: Spade, label: "Limbo" },
  { href: "/games/war", icon: Club, label: "War" },
  { href: "/games/coinflip", icon: Heart, label: "Coin Flip" },
